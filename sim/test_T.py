...
async def test_a(dut):
    ...
    for i in range(160):
        ...
        dut._log.info(" counter value: "+str(dut.counter_indx.value))
        dut._log.info(" 0: "+str(dut.output_written_0.value))
        dut._log.info(" 1: "+str(dut.output_written_1.value))
        dut._log.info(" 2: "+str(dut.output_written_2.value))
